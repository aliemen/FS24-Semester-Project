  ...
  public:
    ...
    void runSolver() override {
        if (this->getStype() == "CG") {
            ...
            if (ippl::Comm->rank() == 0) {
                std::stringstream fname; // Create a stringstream object
                fname << "data/CG_"; // Append the string "data/CG_" to the stringstream
                fname << ippl::Comm->size(); // Append the size of the communicator to the stringstream
                fname << ".csv"; // Append the string ".csv" to the stringstream
